...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(org-level-1 ((t (:foreground ,zenburn-blue-2))))
   `(org-level-2 ((t (:foreground ,zenburn-green+1))))
   `(org-level-3 ((t (:foreground ,zenburn-yellow-2))))
   `(org-level-4 ((t (:foreground ,zenburn-blue-5))))
   `(org-level-5 ((t (:foreground ,zenburn-green))))
